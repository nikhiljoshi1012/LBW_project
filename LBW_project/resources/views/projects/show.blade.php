...
<body>
        ...
        <div class="toolbar">
          ...
          <div class="dropdown tool filetool-selector">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#fileExplorer">
                ...
                <button type="button" class="btn btn-white dropdown-item" id="copyProjectButton" data-project-id="{{ $project->id }}">
                  Make a Copy
                </button>
          ...
          <div class="dropdown tool view-selector">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <div class="dropdown-item-text">
                <div class="resizeInput-container">
                  <div class="form-floating has-validation">
                    <input type="text" class="form-control resizeInput" id="resizeRow" placeholder="Rows">
                  ...
                  <b>X</b>
                  <div class="form-floating has-validation">
                    <input type="text" class="form-control resizeInput" id="resizeCol" placeholder="Columns">
                    <label for="resizeCol" style="font-size:small;">Beats</label>
                    <div id="resizeRowFeedback" class="invalid-feedback " style="font-size:small">
                      Invalid Beat Count
                    </div>
                  </div>
                  <button type="button" class="btn btn-success" onclick="resizeTable()" id="resize-button">Resize</button>
                </div>
              </div>
              ...
              <div class="dropdown-item-text border-top">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="showSwarKeyboard" onchange="toggleDevKeyboard()">
                  <label class="form-check-label" for="showSwarKeyboard">
          ...
          <div class="dropdown tool keyboard-selector">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="javascript:(function(){if(typeof gamabhanaExt != 'undefined') {__predefKb='#gamabhana#'; try { handlePreDefKB(); } catch(x1) {}; gamabhanaExt.changeLayout(null); __predefLangIndex=0; try {handlePreDefLang();} catch(x2) {}; attemptRun();return; } else { t=new Date().getTime();document.body.appendChild(document.createElement('script')).src='https://www.gamabhana.com/gamabhanaWidget/?mode=custom&amp;l=0&amp;k=1&amp;n=&amp;c=devnagari&amp;q='+t;}})();">
                gamabhana
              </a>
              <a class="dropdown-item" href="javascript:(function(){if(typeof gamabhanaExt != 'undefined'){__predefKb='#fontfreedom#'; try { handlePreDefKB();} catch(x1) {}; gamabhanaExt.changeLayout(null); __predefLangIndex=0; try { handlePreDefLang();} catch(x2) {}; 	attemptRun();return; };t=new Date().getTime();document.body.appendChild(document.createElement('script')).src='https://www.gamabhana.com/gamabhanaWidget/?mode=custom&amp;l=0&amp;k=2&amp;n=&amp;c=devnagari&amp;q='+t;})();">
                fontfreedom
              </a>
  ...
  <p>Updated at: <b> {{ $project->updated_at }} </b></p>
      ...
      <div class="table-input-container">
        ...
        <div class="d-flex justify-content-center mt-3">
          <button id="add-r-button" class="btn btn-secondary btn-block" onclick="addRows()" type="button" style="display:none">Add More
            Rows</button>
  ...
  <!-- Modals here -->
  <div class="modal fade " id="fileExplorer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display:none;">
        ...
        <div class="modal-body">
          <div class="container mt-3">
            <div class="row header-row file-item-header">
              <div class="col">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" onchange="toggleCheckBoxes(this)">
              </div>
            ...
            <div class="row rounded list-group-item list-group-item-action file-item">
              <div class="col">
                <input class="form-check-input file-checkbox" type="checkbox" value="" id="{{ $proj->id }}" onchange="activeSelection('{{ $proj->id }}')">
              </div>
              <div class="col" onclick="location.href='{{ route('projects.show', $proj->id) }}'" style="cursor:pointer;">
                {{ $proj->name }}
              </div>
              <div class="col">
                {{ $proj->created_at }}
              ...
              <div class="col">
                ...
                <div class="dropdown file-option-selector">
                  <button class="btn dropdown-toggle rounded-circle filemenu-dropdown" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <svg width="15px" height="15px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#5f6768" class="bi bi-three-dots-vertical" stroke="#5f6768">
                      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                      <g id="SVGRepo_iconCarrier">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a href="{{ route('projects.show', $proj->id) }}" class="dropdown-item">Open</a>
                    <div class="dropdown-item-text btn-danger" style="padding:0;">
                      <form action="{{ route('projects.destroy', $proj->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn" style="width:100%;height:100%; margin:0; color:white;text-align: left;" onclick="return confirm('Are you sure you want to delete this project?')">Delete</button>
                      </form>
                    </div>
                  </div>
                </div>
